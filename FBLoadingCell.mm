...
- (void)drawRect:(CGRect) rect
{
    ...
    if (!self.loading)
    {
        ...
        [text drawInRect:CGRectMake((int)((r.size.width - s.width) / 2), (int)((r.size.height - s.height) / 2), s.width, s.height) withLIStyle:self.theme.summaryStyle lineBreakMode:UILineBreakModeWordWrap];
    }
}
